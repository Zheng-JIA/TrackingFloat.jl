...
###############################################################################################################################################
# why it takes so much time to enter julia environment?
# How to solve the error "ERROR: invalid redefinition of constant TrackingFloat" if some modifications of the struct were made?
import Base: +, *, -, /
